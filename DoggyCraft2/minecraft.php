				...
				<div id="main-content">
					...
					<div id="main-wrap" class="content-wrap">
						...
						<div id="wsite-content" class="wsite-elements wsite-not-footer">
							...
							<?php include 'includes/minecraft/survival.php';?>
							<?php include 'includes/minecraft/creative.php';?>
							<?php include 'includes/minecraft/factions.php';?>
							<?php include 'includes/minecraft/minigames.php';?>
